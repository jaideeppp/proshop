...
import {
    ...
    ORDER_LIST_FAIL,
    ORDER_LIST_MY_FAIL, ORDER_LIST_MY_REQUEST, ORDER_LIST_MY_RESET,
    ORDER_LIST_MY_SUCCESS, ORDER_LIST_REQUEST, ORDER_LIST_SUCCESS, ORDER_PAY_FAIL, ORDER_PAY_REQUEST,
...
export const orderDetailReducer =
    (state = { orderItems: [], shippingAddress: {}, loading: true }, action) => {
        switch (action.type) {
            ...
            case ORDER_DETAILS_RESET: return {
                orderItems: [],
                shippingAddress: {}
            }
...
export const orderDeliverReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case ORDER_DELIVER_FAIL: return {
            loading: false,
            error: action.payload
        }
...
export const orderMyListReducer = (state = { orders: [] }, action) => {
    switch (action.type) {
        ...
        case ORDER_LIST_MY_FAIL: return {
            loading: false,
            error: action.payload
        }

        case ORDER_LIST_MY_RESET: return {
            orders: []
        }
        default: return state
    }
